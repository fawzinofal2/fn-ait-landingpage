...
const puzzloop: Omit<Prisma.AppCreateInput, "slug"> = {
  name: "Puzzloop",
  ...
  permissions: JSON.stringify(["INTERNET", "ACCESS_NETWORK_STATE", "VIBRATE", "BILLING"]),
  analyticsProviders: JSON.stringify(["Firebase Analytics", "Firebase Crashlytics"]),
...
async function main() {
  await prisma.app.upsert({
    where: { slug: "puzzloop" },
    update: puzzloop,
    create: { slug: "puzzloop", ...puzzloop },
  });

  console.log("✅ Seed data upserted: Puzzloop");
}
